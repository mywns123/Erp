...
public class EmployeePanel extends AbstractCotentPanel<Employee> implements ItemListener{
	...
	private void initialize() {
		...
		spinSalary.setModel(new SpinnerNumberModel(2000000, 1500000, 5000000, 1000000));
